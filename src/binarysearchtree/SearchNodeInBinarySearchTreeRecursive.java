...
/*
 * This class helps to search a node in a binary search tree in recursive fashion
 * 
 ...
 *  Output: 15
 */
public class SearchNodeInBinarySearchTreeRecursive {
	
	public Node searchNodeInBinarySearchTreeRecursive(Node root,Node node){
		...
		if(node.data == root.data){
			...
			return searchNodeInBinarySearchTreeRecursive(root.left, node);
		}else{
			return searchNodeInBinarySearchTreeRecursive(root.right, node);			
		}
	}
	...
	public static void main(String args[]){
		...
		SearchNodeInBinarySearchTreeRecursive searchNode = new SearchNodeInBinarySearchTreeRecursive();
		Node result = searchNode.searchNodeInBinarySearchTreeRecursive(root, node);
